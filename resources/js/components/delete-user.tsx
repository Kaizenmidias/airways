...
export default function DeleteUser() {
   ...
   return (
      <Card className="space-y-6 p-6">
         <header>
            <h3 className="mb-0.5 text-base font-medium">Excluir conta</h3>
            <p className="text-muted-foreground text-sm">Exclua sua conta e todos os recursos associados</p>
         </header>

         <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
               <p className="font-medium">Atenção</p>
               <p className="text-sm">Prossiga com cuidado. Esta ação não pode ser desfeita.</p>
            </div>
