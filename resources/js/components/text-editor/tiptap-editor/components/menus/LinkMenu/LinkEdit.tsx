...
const LinkEdit = ({ initialUrl, initialText, isCreate, onApply, onCancel }: LinkEditProps) => {
   ...
   return (
      <form className="rte-link__form" onSubmit={onSubmit}>
         ...
         <Label className="rte-link__label">Texto exibido</Label>
         <Input value={text} onChange={(e) => setText(e.target.value)} className="rte-link__input" placeholder="Digite o texto do link" />
