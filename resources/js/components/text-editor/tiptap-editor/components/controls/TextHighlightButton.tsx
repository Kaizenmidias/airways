...
const TextHighlightButton: React.FC = () => {
   ...
   const renderBar = mounted && buttonRef.current ? createPortal(<div style={highlightBarStyle as CSSProperties} />, buttonRef.current) : null;

   return (
      <>
         <MenuButton ref={buttonRef} type="popover" icon="TextHighlight" hideArrow={true} tooltip="Realce" disabled={state.disabled}>
            <ColorPicker
