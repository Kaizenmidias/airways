   ...
   return (
      <div className="space-y-8">
         <div className="text-center">
            <h1 className="mb-4 text-4xl font-bold text-gray-800">Gerador de certificado do curso</h1>
            <p className="text-muted-foreground text-lg">Gere seu certificado oficial de conclusão do curso</p>
         </div>
            ...
            <Card>
               ...
               <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                     <div className="space-y-2">
                        <Label>Tamanho do certificado</Label>
                        <Select value={certificateSize} onValueChange={setCertificateSize}>
                           <SelectTrigger>
                              <SelectValue placeholder="Select certificate size" />
                           </SelectTrigger>
                           <SelectContent>
                              <SelectItem value="standard">Padrão (800x600)</SelectItem>
                              <SelectItem value="a4">A4 paisagem (842x595)</SelectItem>
                           </SelectContent>
                        </Select>
                     </div>

                     <div className="space-y-3">
                        <Label>Formato do download</Label>
                  ...
                  >
                     ...
                     <div className="relative z-10">
                        <div className="mb-6">
                           ...
                           <h2 className="mb-2 font-serif text-2xl font-bold text-gray-800">Certificado de Conclusão</h2>
                           <div className="mx-auto h-0.5 w-32 bg-amber-400"></div>
                        </div>

                        <div className="space-y-4 text-gray-700">
                           <p className="font-serif text-lg">Certificamos que</p>
                        ...
                        <div className="mt-6 border-t border-amber-400 pt-4">
                           <p className="font-serif text-sm text-gray-500">Certificado autorizado de conclusão</p>
                        </div>
                     </div>
                  </div>
