...
const QuestionAnswerResult = ({ question, answer }: { question: ExamQuestion; answer: AttemptAnswerWithQuestion }) => {
   ...
   switch (question.question_type) {
      case 'multiple_choice': {
         ...
         return (
            <div className="space-y-3">
               <p className="font-semibold text-gray-700">Selecione a opção correspondente:</p>
      ...
      case 'multiple_select': {
         ...
         return (
            <div className="space-y-3">
               <p className="font-semibold text-gray-700">Selecione todas as afirmações aplicáveis:</p>
               <div className="space-y-2">
                  {options.map((option: any, idx: number) => {
      ...
      case 'fill_blank': {
         ...
         return (
            <div className="space-y-3">
               <p className="font-semibold text-gray-700">Preencha as lacunas:</p>
               <div className="space-y-3">
      ...
      case 'ordering': {
         ...
         return (
            <div className="space-y-3">
               <p className="font-semibold text-gray-700">Organize na ordem correta:</p>
               <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div>
                     <p className="mb-2 text-sm font-semibold text-gray-600">Ordem informada:</p>
                     <div className="space-y-2">
                  ...
                  <div>
                     <p className="mb-2 text-sm font-semibold text-gray-600">Ordem correta:</p>
                     <div className="space-y-2">
      ...
      case 'matching': {
         ...
         return (
            <div className="space-y-3">
               <p className="font-semibold text-gray-700">Associe cada item ao seu par:</p>
               <div className="space-y-3">
      ...
      case 'listening': {
         ...
         return (
            <div className="space-y-3">
               <p className="font-semibold text-gray-700">Resposta do aluno:</p>
      ...
      default:
         return (
            <div className="rounded bg-gray-100 p-3">
               <p className="text-sm text-gray-600">Dados da resposta:</p>
