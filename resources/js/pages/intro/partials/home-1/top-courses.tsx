   ...
   return (
      <div className="overflow-y-hidden bg-[url('/assets/images/intro/home-1/bg-line.png')] bg-cover bg-center py-20">
         <Section customize={customize} pageSection={topCoursesSection} containerClass=" relative">
            ...
            <div className="after:pointer-events-none after:absolute after:bottom-20 after:left-0 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(253,18,46,0.82)] after:blur-[180px] after:content-['']"></div>
         </Section>
      </div>
   );
};
