...
const TopInstructors = () => {
   ...
   return (
      <Section customize={customize} pageSection={topInstructorsSection} containerClass="py-20" contentClass="relative">
         ...
         <div className="after:pointer-events-none after:absolute after:right-0 after:bottom-9 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(253,18,46,0.9)] after:blur-[290px] after:content-['']"></div>
      </Section>
   );
};
