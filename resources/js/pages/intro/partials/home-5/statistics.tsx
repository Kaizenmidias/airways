...
const Statistics = () => {
   ...
   return (
      <Section customize={customize} pageSection={statisticsSection} containerClass="relative z-10 py-11">
         <Card className="text-primary-foreground dark:text-primary grid grid-cols-2 gap-20 border-none bg-[#004B50] p-10 !shadow-none md:grid-cols-4 md:flex-row md:gap-28 md:px-[120px]">
