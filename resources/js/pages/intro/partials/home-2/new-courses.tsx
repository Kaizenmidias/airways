...
const NewCourses = () => {
   ...
   return (
      <Section customize={customize} pageSection={newCoursesSection} containerClass="py-20" contentClass="relative z-10">
         <div className="mx-auto text-center md:max-w-2xl">
            <p className="text-secondary-foreground mb-1 font-medium">{newCoursesSection?.title}</p>
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">{newCoursesSection?.sub_title}</h2>
         ...
         <div className="after:pointer-events-none after:absolute after:top-20 after:-left-10 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(97,95,255,1))] after:blur-[290px] after:content-['']"></div>

         <div className="after:pointer-events-none after:absolute after:-right-10 after:bottom-0 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(253,18,46,0.9)] after:blur-[290px] after:content-['']"></div>
      </Section>
   );
};
