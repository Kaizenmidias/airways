   ...
   return (
      <Card className="p-4 sm:p-6">
         <div className="mb-6 flex items-center justify-between">
            <div>
               <h2 className="text-xl font-semibold">Configurações da Mollie</h2>
               <p className="text-gray-500">Configure o gateway de pagamento Mollie</p>
            </div>
         ...
         <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b pb-6">
               <h3 className="mb-4 text-lg font-medium">Credenciais da API</h3>
               <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                     <Label>Chave de teste da API</Label>
                     <Input
                        name="test_api_key"
                  ...
                  <div>
                     <Label>Chave de produção da API</Label>
                     <Input
                        name="live_api_key"
