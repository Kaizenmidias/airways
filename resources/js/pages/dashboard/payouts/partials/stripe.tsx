   ...
   return (
      <Card className="p-4 sm:p-6">
         <div className="mb-6 flex items-center justify-between">
            <div>
               <h2 className="text-xl font-semibold">Configurações do Stripe</h2>
               <p className="text-gray-500">Configure o gateway de pagamento Stripe</p>
            </div>
         ...
         <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className={`border-b pb-6 ${!data.test_mode ? 'opacity-60' : ''}`}>
               <h3 className="mb-4 text-lg font-medium">Credenciais de teste</h3>
            ...
            <div className="border-b pb-6">
               <h3 className="mb-4 text-lg font-medium">Configurações de webhook</h3>
               <div className="grid grid-cols-1 gap-6 md:grid-cols-1">
                  <div>
                     ...
                     <p className="mt-1 text-sm text-gray-500">Webhooks processam eventos do Stripe, como pagamentos concluídos</p>
                  </div>
               </div>
            </div>
