...
const CouponsIndex = ({ coupons, exams }: Props) => {
   ...
   return (
      <>
         <Head title="Cupons de provas" />

         <div className="space-y-6">
            <div className="flex items-center justify-between">
               <div>
                  <h1 className="text-3xl font-bold text-gray-900">Cupons de provas</h1>
                  <p className="mt-1 text-sm text-gray-600">Gerencie cupons de desconto para suas provas</p>
               </div>
               <CouponForm
                  title="Criar cupom"
                  exams={exams}
            ...
            <Card>
               <TableFilter data={coupons} title="Lista de cupons" globalSearch={true} tablePageSizes={[10, 15, 20, 25]} routeName="exam-coupons.index" />
