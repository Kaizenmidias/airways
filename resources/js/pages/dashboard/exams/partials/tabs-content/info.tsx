   ...
   return (
      <Card className="space-y-7 p-4 sm:p-6">
         <div className="flex flex-col justify-between gap-3 md:flex-row">
            <h6 className="w-[200px] font-medium">Perguntas frequentes da prova</h6>
         ...
         <div className="flex flex-col justify-between gap-3 md:flex-row">
            <h6 className="w-[200px] font-medium">Requisitos</h6>
            <div className="w-full space-y-6">
               <Button
                  variant="outline"
                  className="w-full"
         ...
         <div className="flex flex-col justify-between gap-3 md:flex-row">
            <h6 className="w-[200px] font-medium">Resultados de aprendizagem</h6>
            <div className="w-full space-y-6">
               <Button
                  variant="outline"
                  className="w-full"
