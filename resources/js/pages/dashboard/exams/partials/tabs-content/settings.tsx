         ...
         <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-6 md:grid-cols-2">
               ...
               <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Os alunos devem atingir esta porcentagem para serem aprovados</p>
               </div>
               ...
               <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Número máximo de tentativas permitidas por aluno</p>
               </div>
               ...
               <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Nota total da prova</p>
               </div>
            </div>
