      ...
      <>
         ...
         <div className="space-y-6">
            <div className="flex items-center justify-between">
               <div>
                  <h1 className="text-3xl font-bold text-gray-900">Categorias de provas</h1>
                  <p className="mt-1 text-sm text-gray-600">Gerencie categorias e organize suas provas</p>
               </div>
               ...
               <div className="col-span-full">
                  <Card>
                     <CardContent className="flex flex-col items-center justify-center py-12">
                        <p className="mb-4 text-gray-600">Nenhuma categoria encontrada. Crie sua primeira categoria!</p>
                        <CategoryForm
                           title="Create Category"
                           handler={
                              <Button>
