                  ...
                  <div className="space-y-6">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-center gap-3 rounded-lg border p-4">
                           ...
                           <div>
                              <p className="text-muted-foreground text-sm">Enviado em</p>
                        ...
                        <div className="flex items-center gap-3 rounded-lg border p-4">
                           ...
                           <div>
                              <p className="text-muted-foreground text-sm">Atividade</p>
                        ...
                        <div className="flex items-center gap-3 rounded-lg border p-4">
                           ...
                           <div>
                              <p className="text-muted-foreground text-sm">Nota total</p>
                     ...
                     <div className="space-y-4 rounded-lg border p-4">
                        ...
                        {submission.comment && (
                           <div>
                              <p className="mb-2 text-sm font-medium">Comentário do aluno:</p>
