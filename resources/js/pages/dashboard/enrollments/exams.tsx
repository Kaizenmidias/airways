...
const Exams = (props: Props) => {
   ...
   const table = useReactTable({
      ...
      columns: isAdmin ? AdminTableColumn('exam', translate) : InstructorTableColumn('exam', translate),
   ...
   return (
      <div>
         ...
         <Card>
            ...
            <TableFooter className="p-5 sm:p-7" routeName="exam-enrollments.index" paginationInfo={enrollments} />
         </Card>
      </div>
   );
};
