...
const Navbar = () => {
   ...
   const { navbar, translate, courseCategories, blogCategories } = props;
   ...
   return (
      <Card>
         ...
         {showEditor ? (
            <NavbarEditor navbar={navbar} courseCategories={courseCategories} blogCategories={blogCategories} />
         ) : (
