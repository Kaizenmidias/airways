   ...
   return (
      <Card className="p-4 sm:p-6">
         <div className="mb-7 flex items-center justify-between">
            <div>
               <h2 className="text-xl font-semibold">Configurações do ReCaptcha</h2>
               <p className="text-gray-500">Informe a chave do site e a chave secreta do ReCaptcha.</p>
            </div>
         ...
         <form onSubmit={handleSubmit} className="space-y-6">
            <div className="border-b pb-6">
               <h2 className="mb-4 text-xl font-semibold">Configurações do ReCaptcha</h2>
