                     ...
                     <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {data.zoom_web_sdk && (
                           <div className="space-y-4 rounded-lg border bg-blue-50 p-4">
                              <h4 className="font-medium text-blue-900">Credenciais do SDK de reuniões</h4>
            ...
            <div className="space-y-6">
               <Card>
                  ...
                  <CardContent className="space-y-4">
                     <div>
                        <h4 className="mb-2 font-medium">Etapa 1: criar aplicativo Zoom</h4>
                        <p className="text-muted-foreground text-sm">Acesse o Zoom Marketplace e crie um aplicativo OAuth Server-to-Server.</p>
                     </div>
               ...
               <Card>
                  <CardHeader>
                     <CardTitle className="text-lg">Escopos obrigatórios</CardTitle>
                  </CardHeader>
                  <CardContent>
