...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    {
        $this->config = config('paymentgateways.sslcommerz');
    ...
    {
        $this->successUrl = airways_app_url($this->config['success_url']);
    }
    ...
    {
        $this->failedUrl = airways_app_url($this->config['failed_url']);
    }
    ...
    {
        $this->cancelUrl = airways_app_url($this->config['cancel_url']);
    }
    ...
    {
        $this->ipnUrl = airways_app_url($this->config['ipn_url']);
    }
